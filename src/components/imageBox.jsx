    ...
    return (
        <div className={`flex gap-20 items-center flex-col ${Custom_class}`}>
            ...
            <div className='md:w-1/2 w-full'>
                ...
                <Link href="#" className="inline-flex items-center bg-[#1A56DB] justify-center px-5 py-3 mr-3 text-sm font-medium text-center text-white rounded-lg hover:bg-[#1A56DB] focus:ring-none">
                 {Link_title}
