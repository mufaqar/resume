        ...
        <section className="relative bg-white">
            <div className="grid py-8 lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-12 px-4 max-w-screen-xl mx-auto">
                <div className="mr-auto place-self-center lg:col-span-7 max-w-[700px]">
                    ...
                    <Link href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-none">
                    실시간 견적
                    </Link>
                </div>
