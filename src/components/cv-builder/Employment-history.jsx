...
const EmploymentHistory = () => {
  const [components, setComponents] = useState([ <EmpComp />]);

  const RenderComponent = () => {
    setComponents([...components, <EmpComp compID={components.length} />]);
  };
...
const EmpComp = ({ compID }) => {
  ...
  console.log(
    "🚀 ~ file: Employment-history.jsx:49 ~ EmpComp ~ values",
    values
  );
