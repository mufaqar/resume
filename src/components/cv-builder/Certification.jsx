...
const Certification = () => {
  ...
  const [components, setComponents] = useState([<certficationComp/>]);
  const RenderComponent = () => {
    setComponents([...components, <certficationComp compID={components.length}  />]);
  };
      ...
      >
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-gray-800">
            Distribution Manager - Level 2 at Korea Chamber of Commerce and
            Industry
          </span>
